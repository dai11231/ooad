...
<body>
    ...
    <section class="products">
        ...
        <div class="info-section">
            ...
            <p>
                Cà phê chồn là loại cà phê đặc biệt được sản xuất từ hạt cà phê đã qua đường tiêu hóa của loài cầy vòi
                hương (còn gọi là chồn). Quá trình tiêu hóa đặc biệt này làm thay đổi cấu trúc protein của hạt cà phê,
                tạo nên hương vị độc đáo không thể tìm thấy ở bất kỳ loại cà phê nào khác.
            </p>
            <p>
                Cà phê chồn có vị đặc trưng, hài hòa giữa vị đắng nhẹ, chua thanh và ngọt hậu, mang đến trải nghiệm
                thưởng thức tuyệt vời cho người sành cà phê.
            </p>
        </div>
