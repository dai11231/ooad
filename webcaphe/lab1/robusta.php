...
// Tìm category_id cho Robusta
$category_name = 'Robusta';
...
$categoryId = 2; // Mặc định ID cho Robusta
...
// Lấy sản phẩm Robusta từ database với phân trang
